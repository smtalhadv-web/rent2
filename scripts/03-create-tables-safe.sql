-- Safe table creation script that handles existing policies and tables
...
DROP POLICY IF EXISTS "Allow authenticated read" ON rent_records;
DROP POLICY IF EXISTS "Allow authenticated insert" ON rent_records;
DROP POLICY IF EXISTS "Allow authenticated update" ON rent_records;
DROP POLICY IF EXISTS "Allow authenticated delete" ON rent_records;
...
DROP POLICY IF EXISTS "Allow authenticated read" ON rent_history;
DROP POLICY IF EXISTS "Allow authenticated insert" ON rent_history;
DROP POLICY IF EXISTS "Allow authenticated delete" ON rent_history;

DROP POLICY IF EXISTS "Allow authenticated read" ON deposit_adjustments;
DROP POLICY IF EXISTS "Allow authenticated insert" ON deposit_adjustments;
DROP POLICY IF EXISTS "Allow authenticated update" ON deposit_adjustments;
DROP POLICY IF EXISTS "Allow authenticated delete" ON deposit_adjustments;

DROP POLICY IF EXISTS "Allow authenticated read" ON database_connections;
DROP POLICY IF EXISTS "Allow authenticated insert" ON database_connections;
DROP POLICY IF EXISTS "Allow authenticated update" ON database_connections;
DROP POLICY IF EXISTS "Allow authenticated delete" ON database_connections;
...
DROP POLICY IF EXISTS "Allow authenticated delete" ON settings;

-- Now create all the tables (IF NOT EXISTS prevents errors)
...
CREATE TABLE IF NOT EXISTS settings (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  plaza_name TEXT NOT NULL DEFAULT 'Property Management',
  address TEXT,
  phone TEXT,
  email TEXT,
  logo_url TEXT,
...
-- Create RLS Policies for rent_records table
...
-- Create RLS Policies for rent_history table
...
-- Create RLS Policies for deposit_adjustments table
...
-- Create RLS Policies for database_connections table
...
INSERT INTO settings (plaza_name) 
